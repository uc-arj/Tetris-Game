...
//level button
 let levelUpBtn = document.getElementById("increment");
 let levelDownBtn = document.getElementById("decrement");
 //buttons
 let leftBtn= document.querySelector("#leftarrow");
 let rightBtn = document.querySelector("#rightarrow");
